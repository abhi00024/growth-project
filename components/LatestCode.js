...
export default function LatestCode({ repositories }) {
  ...
  return (
    <section className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900 pb-40 mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto  gap-y-20">
        {/* Single github Repo */}
